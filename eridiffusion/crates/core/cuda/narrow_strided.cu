// eridiffusion/crates/core/cuda/narrow_strided.cu
...
extern "C" __global__
void eri_narrow_strided_kernel(
...
extern "C" int eri_narrow_strided_launch(
    const void* src,
    void* dst,
    int rank,
    ...
    void* stream_void)
{
    ...
    eri_narrow_strided_kernel<<<blocks, threads, 0, stream>>>(
