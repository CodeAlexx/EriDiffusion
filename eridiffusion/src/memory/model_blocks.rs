...
use super::config::MemoryFormat;
use super::{cuda_allocator::MemoryError, PrecisionMode};
...
impl ModelType {
    ...
    pub fn recommended_pool_config(&self) -> super::MemoryPoolConfig {
        match self {
            ModelType::FluxDev | ModelType::FluxSchnell => super::MemoryPoolConfig::flux_24gb(),
            ModelType::SD35Large => {
